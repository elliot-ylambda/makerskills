---
name: loopify
description: "Set up a recurring agent loop or cron task: picks ScheduleWakeup vs CronCreate vs /loop, tunes cache-safe delays, adds idempotency and bail-outs."
metadata:
  version: 0.1.0
---
