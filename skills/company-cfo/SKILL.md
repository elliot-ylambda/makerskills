---
name: company-cfo
description: "Run monthly company CFO cadence: pull bank/processor/payroll data, reconcile, compute EOM cash, project runway scenarios; weekly cash pulse mode."
metadata:
  version: 0.1.2
---
